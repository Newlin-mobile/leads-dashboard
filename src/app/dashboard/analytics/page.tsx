    ...
    <div>
      ...
      <div className="grid grid-cols-3 gap-4 mb-8">
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          ...
          <div className="text-3xl font-bold text-green-600">{successfulLeads}</div>
        </div>
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          <div className="text-sm font-medium text-gray-500 mb-1">Success rate</div>
          <div className="text-3xl font-bold text-purple-600">{overallSuccessRate.toFixed(0)}%</div>
        </div>
      </div>

      {/* Performance by source */}
      <div className="bg-white rounded-lg border border-gray-200 p-6 mb-8">
        <h2 className="text-xl font-semibold text-gray-900 mb-4">Performance per bron</h2>
            ...
            <div key={stat.source} className="border-b border-gray-100 pb-4 last:border-0 last:pb-0">
              <div className="flex justify-between items-center mb-2">
                ...
                <div className="text-right">
                  <div className="text-2xl font-bold text-purple-600">{stat.successRate.toFixed(0)}%</div>
      ...
      {bestSource && (
        <div className="bg-purple-50 border border-purple-200 rounded-lg p-6">
          <h2 className="text-lg font-semibold text-purple-900 mb-2">💡 Inzicht voor Noor</h2>
      ...
      <div className="mt-8 bg-gray-50 border border-gray-200 rounded-lg p-6">
        <h2 className="text-lg font-semibold text-gray-900 mb-2">API voor Noor</h2>
